...
public class DatasetImpl extends Persistable<RequestInfoPojo> implements RequestInfo {
   ...
   */
  public DatasetImpl(URL currentLocation, URL finalLocation, URL metacardLocation) {
    super(DatasetImpl.PERSISTABLE_TYPE);
   ...
   */
  public DatasetImpl(RequestInfoPojo pojo) throws PersistenceException {
    super(DatasetImpl.PERSISTABLE_TYPE, null);
    readFrom(pojo);
  }
   ...
   */
  public DatasetImpl(RequestInfo info) {
    super(DatasetImpl.PERSISTABLE_TYPE);
  ...
  public boolean equals(Object obj) {
    if (super.equals(obj) && (obj instanceof DatasetImpl)) {
      final DatasetImpl request = (DatasetImpl) obj;
  ...
  public static RequestInfoPojo toPojo(RequestInfo requestInfo) throws PersistenceException {
    return DatasetImpl.wrap(requestInfo).writeTo(new RequestInfoPojo());
  }
   ...
   */
  public static DatasetImpl wrap(RequestInfo requestInfo) {
    return (requestInfo instanceof DatasetImpl)
        ? (DatasetImpl) requestInfo
        : new DatasetImpl(requestInfo);
  }
}
