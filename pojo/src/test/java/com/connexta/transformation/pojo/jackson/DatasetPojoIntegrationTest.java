...
public class DatasetPojoIntegrationTest {
  ...
  private final RequestInfoPojo pojo =
      new RequestInfoPojo()
          .setVersion(DatasetPojoIntegrationTest.VERSION)
          .setId(DatasetPojoIntegrationTest.ID)
          .setMetacardLocation(DatasetPojoIntegrationTest.METACARD_LOCATION)
          .setCurrentLocation(DatasetPojoIntegrationTest.CURRENT_LOCATION)
          .setFinalLocation(DatasetPojoIntegrationTest.FINAL_LOCATION);

  private final JSONObject jsonObject;

  public DatasetPojoIntegrationTest() throws Exception {
    jsonObject =
        new JSONObject()
            .put("clazz", "request")
            .put("id", DatasetPojoIntegrationTest.ID)
            .put("version", DatasetPojoIntegrationTest.VERSION)
            .put("metacard_location", DatasetPojoIntegrationTest.METACARD_LOCATION)
            .put("current_location", DatasetPojoIntegrationTest.CURRENT_LOCATION)
            .put("final_location", DatasetPojoIntegrationTest.FINAL_LOCATION);
  }
